...
{
  "$end", "error", "$undefined", "INTEGER", "PLUS", "MINUS", "MUL", "DIV",
...
#line 23 "expr.y" /* yacc.c:1646  */
    { printf("Answer: %d\n", Evaluate((yyvsp[-1].n))); return 1;}
#line 1226 "y.tab.c" /* yacc.c:1646  */
    break;

  case 3:
#line 26 "expr.y" /* yacc.c:1646  */
    { (yyval.n) = MakeOperatorNode('+', (yyvsp[-2].n), (yyvsp[0].n)); }
